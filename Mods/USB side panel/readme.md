...
- 2x heatsets
- 2x screws (dont remember size)

### Known fitment issue
- Will likely interfere with larger size batteries or if using a the full size PI mod (moving the second PI back and using double side tape for the mount fixed that)
